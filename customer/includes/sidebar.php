...
<a href="http://localhost:3000/channels/me" target=" "> <i class="fas fa-comment-dots"></i> Chat </a>

</li>

<li class="<?php if(isset($_GET['video_call'])){ echo "active"; } ?>">

<a href="http://localhost:9000" target=" "> <i class="fas fa-video"></i> Video Call </a>
...
<li class="<?php if(isset($_GET['recentlyviewed'])){ echo "active"; } ?>">

<a href="my_account.php?recentlyviewed"> <i class="fas fa-eye"></i> Recently Viewed </a>

</li>

<li class="<?php if(isset($_GET['pairing'])){ echo "active"; } ?>">

<a href="my_account.php?pairing"> <i class="fa fa-plus"></i> Pairing </a>
