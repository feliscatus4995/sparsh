  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> AT BEYOND TRENDS
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<!-- <h1 style="font-size:45px;font-weight: 600;color: #995251;font-family: Allura, cursive;padding-bottom: 2px;"> Register A New Account </h1> -->

<h1 style="font-size:45px;font-weight: 600;color: #995251;font-family: Allura, cursive;padding-bottom: 2px;">Register</h1>

<!-- <p class="lead" style="font-variant: small-caps;font-size: 20px;font-weight: bolder;color: #222;">A NEW ACCOUNT</p> -->
...
<div class="g-recaptcha" data-sitekey="6Lc2DcEZAAAAABAEwVHSLk2-tg2okyj01DVoLK6U"></div>
...
$secret = "6Lc2DcEZAAAAAObdr0zjAREjXKZXwWzcDBxM9Hor";
...
$from = "prarthanapande01@gmail.com";
